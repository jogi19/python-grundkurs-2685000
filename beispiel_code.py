...
parser.add_argument("--optional_str", help="Optionaler String", type=str)
parser.add_argument("--wahl", help="Meine Wahl", choices=["a", "b", "c", "d"])

args = parser.parse_args()

print("Integer:",args.pflicht_int, "- Type", type(args.pflicht_int))
print("Optional Integer:",args.optional_int, "- Type", type(args.optional_int))
